...
style={{
  ...
  <div className="relative pt-20 text-center">
    ...
    <div className="px-6 sm:px-12">
      <h5 className="text-xl font-bold text-gray-900">Lorem ipsum dolor sit amet.</h5>
    ...
    <dl
      className="flex flex-col items-center justify-center px-6 py-4 mt-6 border-t border-gray-100 sm:flex-row sm:items-start sm:px-12"
    >
