    ...
    <div class="max-w-screen-xl px-4 py-16 mx-auto space-y-12 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div class="lg:order-last">
          ...
          <form class="mt-4">
            <div class="relative">
              <label for="email" class="sr-only">Todo item</label>
              <input
                type="email"
                id="email"
                placeholder="john@doe.com"
                class="block w-full h-16 pl-4 pr-16 border-gray-200 rounded-lg sm:text-sm"
              />
  
              <button
                type="button"
                class="absolute p-2 text-white transform -translate-y-1/2 bg-green-600 rounded-full shadow-lg hover:bg-green-500 right-4 top-1/2"
              >
          ...
          <a href="" target="_blank" rel="noreferrer" aria-label="Facebook" class="hover:opacity-75">
          ...
          <a href="" target="_blank" rel="noreferrer" aria-label="Instagram" class="hover:opacity-75">
            <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" class="w-6 h-6">
              <path
                fill-rule="evenodd"
