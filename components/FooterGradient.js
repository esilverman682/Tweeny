...
const FooterGradient = () => {
  return (
    ...
    <div className="max-w-screen-xl px-4 pb-8 mx-auto pt-36 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <a
          href=""
          className="inline-flex items-center px-5 py-3 mt-8 font-medium border border-white border-opacity-25 rounded-full hover:bg-white hover:text-red-500"
        >
          Get started
      ...
      <div
        className="pt-8 border-t border-white border-opacity-25 sm:items-center sm:justify-between mt-36 sm:flex"
      >
        ...
        <div className="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0">
          <a
            ...
            rel="noreferrer"
            aria-label="Facebook"
            className="p-2 border border-white border-opacity-25 rounded-full hover:opacity-75"
          >
